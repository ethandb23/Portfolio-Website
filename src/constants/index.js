...
const projects = [
  {
    name: "3D Customizeable Product Showcase",
    description:
      "A 3D product showcase which allows users to users to customize the color of and add a logo to a 3D T shirt, then download it if they choose. Currently implementing DALL-E AI to render images generated by user prompt.",
    tags: [
      {
        name: "Vite",
    ...
    image: tshirt,
    source_code_link: "https://github.com/ethandb23/AI-3D-Product-Showcase",
    deploy_link: "",
  },
  {
    name: "CodeIt",
